...
import static org.apache.slider.ext.ExtConstants.ARG_TEMPLATE_MEMORY_NAME;

/**
 * Created by jpliu on 2020/9/23.
 */
public class TemplateMemoryArgsDelegate extends AbstractArgsDelegate {
    @Parameter(names = {ARG_TEMPLATE_MEMORY_NAME},
            arity = 3,
            description = "--template.mem <name> <xms> <xmx>  , measure in MB . ",
